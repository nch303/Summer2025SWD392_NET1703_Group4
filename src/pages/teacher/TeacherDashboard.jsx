    ...
    <div className="teacher-dashboard">
      <div className="dashboard-header">
        ...
        <div className="dashboard-actions">
          <Button type="primary" icon={<PlusOutlined />}>New Assignment</Button>
        </div>
      </div>
      ...
      <Row gutter={[24, 24]} className="charts-section">
        ...
        <Col xs={24} md={12}>
          <Card title="Student Performance" className="chart-card">
            <div className="chart-container">
              <Bar 
      ...
      {/* Schedule and Activities Section */}
      <Row gutter={[24, 24]} className="schedule-activities-section">
        <Col xs={24} md={12}>
