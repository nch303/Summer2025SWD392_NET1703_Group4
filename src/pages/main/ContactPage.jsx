...
const ContactPage = () => {
  ...
  return (
    <div className={styles.contactContainer}>
      ...
      <section className={`${styles.contactSection} ${styles.contactMainSection}`}>
          ...
          <div className={styles.contactGrid}>
            ...
            <div className={styles.contactFormContainer}>
              <div className={styles.contactFormHeader}>
                ...
                <div className={styles.contactFormUnderline}></div>
              </div>
              ...
              {submitted ? (
                ...
                <form className={styles.contactForm} onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className={styles.contactBtnSubmit}>Send Message</button>
                </form>
              )}
              
              <div className={`${styles.contactDecorationElement} ${styles.contactStar1}`}></div>
              <div className={`${styles.contactDecorationElement} ${styles.contactStar2}`}></div>
              <div className={`${styles.contactDecorationElement} ${styles.contactCircle1}`}></div>
            </div>
            ...
            <div className={styles.contactInfoContainer}>
              <div className={styles.contactInfoCard}>
                <div className={styles.contactInfoHeader}>
                  ...
                  <div className={styles.contactInfoUnderline}></div>
                </div>
                ...
                <div className={styles.contactSocial}>
                  ...
                  <div className={styles.contactSocialIcons}>
                    <a href="#" className={styles.contactSocialIcon}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
      ...
      {/* Map Section */}
      <section className={`${styles.contactSection} ${styles.contactMapSection}`}>
        <div className={styles.contactSectionContainer}>
          <div className={styles.contactSectionHeader}>
            <h2>Find Us</h2>
            <div className={styles.contactSectionUnderline}></div>
          </div>
          <div className={styles.contactMapContainer}>
            ...
            ></iframe>
            <div className={styles.contactMapMarker}>
              <div className={styles.contactMarkerIcon}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
              </div>
      ...
      {/* FAQ Section */}
      <section className={`${styles.contactSection} ${styles.contactFaqSection}`}>
        <div className={styles.contactSectionContainer}>
          <div className={styles.contactSectionHeader}>
          ...
          <div className={styles.contactFaqCta}>
            <p>Don't see your question? Contact us directly!</p>
            <button className={styles.contactBtnSecondary}>View All FAQs</button>
          </div>
        </div>
      </section>
      
      {/* CTA Section */}
      <section className={`${styles.contactSection} ${styles.contactCtaSection}`}>
        <div className={`${styles.contactCloudDecoration} ${styles.contactCloud1}`}></div>
        <div className={`${styles.contactCloudDecoration} ${styles.contactCloud2}`}></div>
        <div className={styles.contactSectionContainer}>
          <div className={styles.contactCtaContent}>
            ...
            <button className={styles.contactBtnPrimary}>Schedule a Tour Today</button>
          </div>
        </div>
      </section>
    </div>
