                  ...
                  {isDropdownOpen && (
                    <div className={styles.userDropdown}>
                      ...
                      {currentUser?.roleName === 'Staff' && (
                        <Link to="/staff" className={styles.dropdownItem} onClick={() => setIsDropdownOpen(false)}>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 15.5h-2V19h2v-.5zm0-2.5h-2c0-3.25 3-3 3-5 0-1.1-.9-2-2-2s-2 .9-2 2h-2c0-2.21 1.79-4 4-4s4 1.79 4 4c0 2.5-3 2.75-3 5z" />
                          </svg>
                          Staff Dashboard
                        </Link>
                      )}
                      {currentUser?.roleName === 'Teacher' && (
                        <Link to="/teacher" className={styles.dropdownItem} onClick={() => setIsDropdownOpen(false)}>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      {currentUser?.roleName === 'Parent' && (
                        <>
                          <Link to="/tuition-fee" className={styles.dropdownItem} onClick={() => setIsDropdownOpen(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                              <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V5H10.9v1.69c-1.51.32-2.72 1.3-2.72 2.81 0 1.79 1.49 2.69 3.66 3.21 1.95.46 2.34 1.15 2.34 1.87 0 .53-.39 1.39-2.1 1.39-1.6 0-2.23-.72-2.32-1.64H8.04c.1 1.7 1.36 2.66 2.86 2.97V19h2.34v-1.67c1.52-.29 2.72-1.16 2.73-2.77-.01-2.2-1.9-2.96-3.66-3.42z"/>
                            </svg>
                            Tuition Fee
                          </Link>
